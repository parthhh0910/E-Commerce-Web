        ...
        const items = cart
          ...
          .map(item => ({
            ...
            imageUrl: item.imageType
              ...
              : (PRODUCT_IMAGES[item.name] || `https://picsum.photos/seed/${item.id}/200/200`)
          }));
        setCartItems(items);
      } catch {
              ...
              return (
                <div key={item.id} className="fk-cart-item">
                  <img
                    ...
                    onError={e => { e.target.onerror = null; e.target.src = PRODUCT_IMAGES[item.name] || `https://picsum.photos/seed/${item.id}/200/200`; }}
                  />
